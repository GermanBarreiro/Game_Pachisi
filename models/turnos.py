...
class Turno:
    ...
    def quien_empieza(self):
        ...
        indice_inicial = self.Players.index(jugador_inicial)
        self.Players = self.Players[indice_inicial:] + self.Players[:indice_inicial]

       #print('El nuevo orden de los jugadores es:')
